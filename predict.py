...
class BertPredictor:
    ...
    def predict_by_examples(self, examples: List[Example]):
        ...
        hr_tensor_list, tail_tensor_list, hr_tensor_list_mm= [], [], []
        logger.info("Start to predict by examples. ")

        print('注意：************************************输出多模态融合查询表示*************************************************')
...
#==============================================================================================================================================================
        return torch.cat(hr_tensor_list, dim=0), torch.cat(tail_tensor_list, dim=0), torch.cat(hr_tensor_list_mm, dim=0)
